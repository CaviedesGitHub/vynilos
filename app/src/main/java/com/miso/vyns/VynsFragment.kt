 ...
 * Use the [VynsFragment.newInstance] factory method to
...
class VynsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnAlbums.setOnClickListener {
            val action = VynsFragmentDirections.actionVynsFragmentToAlbumListFragment()
    ...
    companion object {
         ...
         * @return A new instance of fragment VynsFragment.
         */
